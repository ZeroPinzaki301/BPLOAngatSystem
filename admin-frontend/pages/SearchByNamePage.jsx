// src/pages/admin/SearchByNamePage.jsx
...
const SearchByNamePage = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const res = await axiosInstance.get(`/api/admin/analysis/search/name?${params}`);
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">Search Businesses by Name</h1>
        ...
        <form onSubmit={handleSearch} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Enter first name, last name, or business name..."
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
            <p className="mt-1 text-sm text-gray-500">
              Searches in: First Name, Middle Name, Last Name, and Business Name
            </p>
          </div>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-64">
            ...
            <p className="text-gray-500">No businesses found matching "{searchTerm}"</p>
          </div>
        ) : (
          <div className="flex flex-col items-center justify-center h-64">
            <p className="text-gray-500">Enter a name to search for businesses</p>
          </div>
        )}
      </div>
    </div>
